...
<template>
  <div class="w-full flex items-start">
    <div
      class="fixed left-0 top-8 pt-1 bg-gray-100 w-[220px] min-h-screen flex flex-col overflow-y-auto"
    >
        ...
        <thead class="bg-gray-50">
          <tr>
            <th
              ...
              :key="column"
              class="border-b border-gray-200 px-4 py-2 text-left font-bold text-gray-600 max-w-[200px] truncate bg-gray-50 z-0"
            >
              {{ column }}
            </th>
          </tr>
